...
import type { ExternalBlob as _ExternalBlob, ShoeListing as _ShoeListing, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async completeTrade(arg0: Principal, arg1: Principal, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeTrade(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createListing(arg0: string, arg1: bigint, arg2: ExternalBlob, arg3: bigint, arg4: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createListing(arg0, arg1, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListings(arg0: bigint, arg1: bigint, arg2: boolean): Promise<Array<ShoeListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListings(arg0, arg1, arg2);
...
async function from_candid_ShoeListing_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ShoeListing): Promise<ShoeListing> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        collection: await from_candid_vec_n9(_uploadFile, _downloadFile, value.collection),
...
async function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ShoeListing>): Promise<Array<ShoeListing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ShoeListing_n10(_uploadFile, _downloadFile, x)));
}
